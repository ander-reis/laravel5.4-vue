...
<script type="text/javascript">
    ...
    export default {
        computed: {
            classInformations() {
                return store.state.student.classInformation.classInformations;
            }
        },
        mounted() {
            store.dispatch('student/classInformation/query');
            store.dispatch('student/classInformation/get', 1);
        }
    }
</script>